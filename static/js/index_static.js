...
function world_static_list() {
    ...
    $("#china_total").text(15801);  //中国累计接种
    $("#china_new").text(15802);    // 中国新增接种
    $("#china_per").text(15803);    // 中国每百人接种
    $("#word_per").text(15804);     // 全球每百人接种
    $("#word_new").text(15805);      // 全球新增接种
    $("#word_total").text(15806);   //全球累计接种
}
//echart_1中国城市疫情排行
